...
function [Dati]=C_dati_6(test) %Test 1 per il caso 1 %Test2 per il caso 2
L=1;
if test=='Test1'
Dati = struct( 'name',             test,...
               ...
               ... % du/dx 
               'force',           '1*(2*pi)^2*sin(2*pi*x)-4*pi^2*sin(2*pi*x)',...  
...
Dati = struct( 'name',             test,...
               ...
               'grad_exact',     '2*pi*cos(2*pi*x)',...    
               ... % du/dx 
               'force',           '1*(1000*pi)^2*sin(2*pi*x)-4*pi^2*sin(2*pi*x)',...  
               ... % Forcing term %d^2u/dx^2+n^2w^2u
               'fem',              'P1',...         
               ... % P1-fe
               'nqn_1D',            2,...           
